const AdminLoginForm = ({ error, isLoading, onSubmit }) => (
  <div className="min-h-screen flex items-center justify-center p-4">
    <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-sm scroll-reveal">
      ...
      <form onSubmit={(e) => { e.preventDefault(); const formData = new FormData(e.target); onSubmit({ email: formData.get('email'), password: formData.get('password') }); }} className="space-y-6">
        <div>
          <label
